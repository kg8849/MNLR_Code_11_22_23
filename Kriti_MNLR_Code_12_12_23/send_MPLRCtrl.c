...
//	printf("\n TEST: Frame size is %d\n ", frame_Size);
	...
	// Destination MAC Address- this is used in sending? 
	...
	socket_address.sll_addr[5] = MY_DEST_MAC5;
			 ...
			 // For testing purpose: NS uncommented on 12-1-23 to check contents of frame 
/*
		  int testIndex = 0;
		  int testSize=0;
		...
		for (; testIndex < testSize; testIndex++) {
			printf("MPLR Ctrl Pack in send_MPLRCtrl %d : %02x \n ",testIndex ,frame[testIndex] & 0xff);
		}
		printf("\n");
